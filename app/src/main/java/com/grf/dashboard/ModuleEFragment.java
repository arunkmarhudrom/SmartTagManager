...
public class ModuleEFragment extends Fragment {
    private static final String TAG = "ModuleEFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            return inflater.inflate(R.layout.fragment_module_e, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        try {
            tvTitle = view.findViewById(R.id.tvModuleTitleE);
            tvContent = view.findViewById(R.id.tvModuleContentE);
            ...
            viewModel.setText("Welcome to Module E");
        } catch (Exception e) {
