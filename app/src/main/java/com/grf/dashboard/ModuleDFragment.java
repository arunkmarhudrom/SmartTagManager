...
public class ModuleDFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            return inflater.inflate(R.layout.fragment_module_d, container, false);
        } catch (Exception e) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        try {
            tvTitle = view.findViewById(R.id.tvModuleTitleD);
            tvContent = view.findViewById(R.id.tvModuleContentD);
            ...
            viewModel.BindModuleData(view, viewModel, requireContext(), getViewLifecycleOwner(),"D");
            ...
            viewModel.setText("Welcome to Module D");
        } catch (Exception e) {
