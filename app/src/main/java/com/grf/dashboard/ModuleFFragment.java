...
public class ModuleFFragment extends Fragment {
    private static final String TAG = "ModuleFFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            return inflater.inflate(R.layout.fragment_module_f, container, false);
        } catch (Exception e) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        try {
            tvTitle = view.findViewById(R.id.tvModuleTitleF);
            tvContent = view.findViewById(R.id.tvModuleContentF);
            ...
            viewModel.BindModuleData(view, viewModel, requireContext(), getViewLifecycleOwner(),"F",0);
            ...
            viewModel.setText("Welcome to Module F");
        } catch (Exception e) {
